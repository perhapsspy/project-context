...
| --- | --- | --- | --- | --- | --- |
| `docs/system.md` | system notes | current | project-wide | `REFERENCE -> docs/reference/system/system-overview.md` | 현재 시스템 상수는 canonical reference로 정리하고 memory에는 다시 복사하지 않는다. |
...
4. 별도 current global note가 없으면 `docs/memory.md`는 빈 current surface로 둔다
